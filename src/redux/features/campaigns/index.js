...
export const getAllUsersThunkMiddleware = () => {
  return async (dispatch) => {
    try {
      ...
      // const response = await axios.get(`https://p2.kcptl.in/account/get`);
...
export const sendDocumentVaribleValuesThunkMiddleware = ({
  ...
  return async (dispatch) => {
    try {
      ...
      // const response = await axios.post("https://p2.kcptl.in/docs/mergeMapped", {
...
export const downloadCampaignSinglePdfFileThunkMiddleware = ({ campaignName }) => {
  return async (dispatch) => {
    try {
      ...
      // link.target = "_blank"
      // const link = document.createElement("a");
      // link.href = `https://p2.kcptl.in/docs/downloadpdf?campaignName=${campaignName}`
      // link.target = "_blank";
      // document.body.appendChild(link);
      // link.click();
